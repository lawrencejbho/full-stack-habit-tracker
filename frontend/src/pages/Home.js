    ...
    <div className="tw-bg-[#f4ede3] tw-h-screen tw-overflow-x-hidden tw-overflow-y-hidden ">
      ...
      <div className="tw-w-full tw-h-[75%]">
        <div className=" tw-flex tw-flex-col tw-absolute  tw-border-4 tw-justify-center  tw-items-center tw-overflow-x-hidden tw-overflow-y-hidden tw-visible sm:tw-invisible sm:tw-hidden tw-w-full">
          <img
            className="tw-w-[90%] tw-visibile tw-top-20 sm:tw-invisible"
            src={LogoHeading}
            alt="heading"
          />
          <img
            className="tw-w-[70%] tw-h-[75%] tw-visible sm:tw-invisible"
            src={HeroSmall}
            alt="heading"
          />
        </div>

        <div className=" tw-flex sm:tw-z-10 tw-invisible sm:tw-visible tw-absolute tw-border-4 tw-justify-center tw-items-center tw-w-full tw-h-auto tw-overflow-x-hidden tw-overflow-y-hidden tw-bg-[#f4ede3]">
          <img
            className="tw-w-full lg:tw-w-[75%] xl:tw-max-w-[1000px] tw-invisible sm:tw-visible tw-items-center tw-justify-center tw-flex "
            src={Hero}
            alt="hero"
          />
        </div>
      ...
      <div className="tw-w-full tw-flex tw-flex-col tw-items-center tw-justify-center tw-z-30">
        <a className="tw-absolute tw-bottom-28 tw-z-20" href="/login">
